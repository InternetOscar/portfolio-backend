...
export interface ElementsProjectTags extends Schema.Component {
  collectionName: 'components_elements_project_tags';
  info: {
    displayName: 'project_tags';
    icon: 'bulletList';
  };
  attributes: {
    label_a: Attribute.String;
    label_b: Attribute.String;
    label_c: Attribute.String;
  };
}

export interface ElementsStack extends Schema.Component {
...
declare module '@strapi/types' {
  export module Shared {
    export interface Components {
      ...
      'elements.project-tags': ElementsProjectTags;
